...
@Component({
  selector: 'app-graphmovil-new',
  templateUrl: './graphmovil-new.component.html',
  styleUrls: ['./graphmovil-new.component.css']
})
export class GraphmovilNewComponent implements OnInit {
 ...
 user:User;
  ...
  newGraph(){
    ...
    this.router.navigate(['/telcomovil/graficasm/1'])
  ...
  //     this.router.navigate(['/telcomovil/graficasm'+data['content']._id])
  //    }else{
