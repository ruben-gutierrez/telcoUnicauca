...
import { UsersService, ArquitecturesService, GraphsService } from "src/app/services/services.index";
import 'chartjs-plugin-zoom';
import { ChartDataSets, ChartOptions, ChartType } from 'chart.js';
import { Color, Label, MultiDataSet } from 'ng2-charts';
import { BaseChartDirective } from 'ng2-charts';
@Component({
  selector: 'app-graficastelcomovil',
  templateUrl: './graficastelcomovil.component.html',
  styleUrls: ['./graficastelcomovil.component.css']
})
export class GraficastelcomovilComponent implements OnInit {
