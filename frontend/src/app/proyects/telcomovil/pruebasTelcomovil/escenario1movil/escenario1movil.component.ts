...
export class Escenario1movilComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.formNewTest = new FormGroup({
      ...
      idBtnEnviar: new FormControl(null),
  ...
  newPrueba() {
    ...
    var btn_id = <HTMLInputElement>document.getElementById('btnenviar');
    btn_id.disabled = true;
    console.log("aaaaaaaaaaaaaaaaaaaaaaaaaaaa", btn_id)
    this.formNewTest.controls['idBtnEnviar'].setValue(btn_id)
